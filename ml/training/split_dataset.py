...
Works on the processed Triad feature table:
...
def _stratified_split_indices(
    ...
    *,
    ...
    """
    Simple stratified split using only stdlib (no sklearn).
    """
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Split processed dataset into train/val/test CSVs.")
    parser.add_argument(
        "--input",
        type=str,
