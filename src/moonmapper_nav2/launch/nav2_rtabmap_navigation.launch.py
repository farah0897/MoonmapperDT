"""Nav2 for live RTAB-Map /map: no map_server, no AMCL, no identity map->odom TF."""
...
def generate_launch_description() -> LaunchDescription:
    ...
    default_params = os.path.join(nav2_pkg, "config", "nav2_params_rtabmap_real.yaml")
        ...
        [
            ...
            LogInfo(
                msg=(
                    ...
                    "(no map_server/AMCL/identity map->odom). Expect /map from relay + RTAB map->odom TF."
                )
            ),
