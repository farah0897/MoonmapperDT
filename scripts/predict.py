"""
Predict material/object label for a new Triad raw burst CSV.

Inputs:
  --raw  Path to a raw burst CSV (36 spectral columns, multiple rows)
...
def main() -> int:
    p = argparse.ArgumentParser(description="Predict label from Triad raw burst CSV (Random Forest).")
